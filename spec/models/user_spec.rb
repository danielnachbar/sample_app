...
describe User do
  ...
  it "should create a new instance give a valad addtribute" do
    User.create!(@attr)
  end
  ...
  describe "password validations" do
    ...
    it "should require a matching pasword confirmation" do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with no user" do
        User.authenticate("bar@bar.bar", @attr[:password]).should be_nil
        
      end
      
      it "should return the user instance on email/password match" do
